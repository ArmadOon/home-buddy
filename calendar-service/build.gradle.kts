...
version = "1.0.0"
group = "com.armadoon.homebuddy.calendar"
...
openApiGenerate {
    ...
    inputSpec.set("${project.projectDir}/shared/openapi-specs/calendar-service.yaml")
...
application {
    mainClass = "com.armadoon.homebuddy.calendar.ApplicationKt"
}
...
micronaut {
    ...
    processing {
        incremental(true)
        annotations("com.armadoon.homebuddy.calendar.*")
    }
    aot {
